...
export const ConfirmChangePassword = () => {
  ...
  useEffect(() => {
    const confirmChange = async () => {
      ...
      try {
        const response = await api.get(`/api/auth/confirm-change-password?token=${token}`);
        if (response.data.success) {
          setStatus('success');
          setMessage(response.data.message || 'Password aggiornata con successo!');
        } else {
          setStatus('error');
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{
          background: `
            radial-gradient(ellipse 80% 50% at 50% -10%, rgba(245, 158, 11, 0.1) 0%, transparent 60%),
      ...
      <div
        ...
        style={{
          ...
          background: 'radial-gradient(ellipse 100% 100% at 50% -30%, rgba(245, 158, 11, 0.12) 0%, transparent 70%)',
          zIndex: 1,
        }}
      />
      ...
      >
        <div
          style={{
            ...
            boxShadow: `0 4px 24px rgba(0, 0, 0, 0.4), 0 0 60px rgba(245, 158, 11, 0.04)`,
        ...
        >
          ...
          <div className="text-center">
            ...
            >
              ...
              {status === 'success' && 'Password Aggiornata!'}
            ...
            >
              {status === 'loading' && 'Stiamo aggiornando la tua password...'}
              ...
              >
                <Link
                  ...
                  style={{
                    ...
                    fontWeight: 600,
                    color: status === 'success' ? '#0a0a09' : colors.textPrimary,
                    background: status === 'success'
                      ? `linear-gradient(135deg, ${colors.accentLight}, ${colors.accent})`
                      : 'rgba(255, 255, 255, 0.05)',
                    border: status === 'success' ? 'none' : `1px solid ${colors.border}`,
                    borderRadius: isMobile ? '12px' : '14px',
                    textDecoration: 'none',
                    boxShadow: status === 'success' ? `0 4px 15px ${colors.accent}25` : 'none',
                  }}
                >
